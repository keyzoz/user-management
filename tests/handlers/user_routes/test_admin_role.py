...
async def test_get_user_with_admin_role(
    ac: AsyncClient, generate_group_name, generate_random_admin_data
):
    admin_user_data = generate_random_admin_data
...
async def test_get_user_from_other_group_with_admin_role(
    ac: AsyncClient,
    generate_group_name,
    generate_random_admin_data,
    generate_random_user_data,
):
    data1 = generate_random_admin_data
    password = data1[0]
    user_data1 = data1[1]
